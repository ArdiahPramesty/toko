                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Data </span></a>
                            <ul aria-expanded="false" class="collapse  first-level" style="padding-left: 20px;">
                                ...
                                <li class="sidebar-item"><a href="<?php echo base_url('index.php/admin/C_MasterCustomer') ?>" class="sidebar-link"><i class="mdi mdi-receipt"></i><span class="hide-menu"> Customer </span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-message-draw"></i><span class="hide-menu">Transaksi </span></a>
                            <ul aria-expanded="false" class="collapse  first-level" style="padding-left: 20px;">
                                ...
                                <li class="sidebar-item"><a href="<?php echo base_url('index.php/admin/C_TransaksiPembayaran') ?>" class="sidebar-link"><i class="mdi mdi-receipt"></i><span class="hide-menu"> Pembayaran </span></a></li>
                                <li class="sidebar-item"><a href="<?php echo base_url('index.php/admin/C_TransaksiRetur') ?>" class="sidebar-link"><i class="mdi mdi-receipt"></i><span class="hide-menu"> Retur </span></a></li>
